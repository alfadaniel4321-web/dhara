      ...
      <div className="su-fade-up" style={{ animationDelay: '0.15s', padding: '0 1rem' }}>
        <motion.div animate={shakeError} transition={{ duration: 0.4 }} style={{
          ...
          <form onSubmit={handleSignup} noValidate>
            ...
            {/* ── Social Login ── */}
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }} style={{ marginTop: '1.25rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
                <div style={{ flex: 1, height: '1px', background: 'rgba(27,67,50,0.06)' }} />
                <span style={{ fontFamily: '-apple-system, sans-serif', fontSize: '0.65rem', fontWeight: 400, color: 'rgba(27,67,50,0.3)', whiteSpace: 'nowrap' }}>
                  or continue with
                </span>
                <div style={{ flex: 1, height: '1px', background: 'rgba(27,67,50,0.06)' }} />
              </div>
              <div style={{ display: 'flex', gap: '0.6rem' }}>
                <button type="button" style={{
                  ...
                  padding: '0.75rem', borderRadius: '12px', border: '1px solid rgba(27,67,50,0.08)',
                  background: '#FFFFFF', cursor: 'pointer', fontFamily: '-apple-system, sans-serif',
                  fontSize: '0.72rem', fontWeight: 600, color: '#1B4332',
                  transition: 'all 0.2s ease',
                }}
                  onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(27,67,50,0.2)'; e.currentTarget.style.background = 'rgba(27,67,50,0.02)'; }}
                  onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(27,67,50,0.08)'; e.currentTarget.style.background = '#FFFFFF'; }}
                >
